...
namespace Tests
{
    public class TestsMOVBlock{
        ...
        public void MOVAMovesASourceToADest(){
            ...
            block.Execute(sim,0);
            Assert.That(sim.GetBlock(42,0)._regA.Get() == 3);
        }
        ...
        public void MOVBMovesBSourceToBDest(){
            ...
            block.Execute(sim,0);
            Assert.That(sim.GetBlock(42,0)._regB.Get() == 8);
        }
        ...
        public void MOVABMovesASourceToBDest(){
            ...
            block.Execute(sim,0);
            Assert.That(sim.GetBlock(14,0)._regB.Get() == 3);
        }
        ...
        public void MOVBAMovesBSourceToADest(){
            ...
            block.Execute(sim,0);
            Assert.That(sim.GetBlock(14,0)._regA.Get() == 8);
        }
        ...
        public void MOVFMovesABSourceToABDest(){
            ...
            block.Execute(sim,0);
            Assert.That(sim.GetBlock(20,0)._regA.Get() == 3);
            Assert.That(sim.GetBlock(20,0)._regB.Get() == 8);
        }
        ...
        public void MOVXMovesABSourceToABDest(){
            ...
            block.Execute(sim,0);
            Assert.That(sim.GetBlock(20,0)._regA.Get() == 8);
            Assert.That(sim.GetBlock(20,0)._regB.Get() == 3);
        }
        ...
        public void MOVIMovesourceToDest(){
            ...
            Assert.That(sim.GetBlock(20,0)._regA.Get() == 0);
            Assert.That(sim.GetBlock(20,0)._regB.Get() == 20);
